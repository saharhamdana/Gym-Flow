...
import { 
  ...
  ArrowLeft, Bell, Shield, Calendar, Info 
} from 'lucide-react';
  ...
  if (file) {
    ...
    reader.onloadend = () => {
      ...
      img.onload = () => {
        ...
        // Convertir en base64 avec compression (0.7 = 70% de qualité)
...
<div className="flex items-center space-x-6 mb-8 pb-8 border-b border-gray-200">
  <div className="w-24 h-24 bg-blue-500 rounded-full flex items-center justify-center text-white text-3xl font-bold overflow-hidden">
    {profileData.photo ? (
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600">support@gymflow.com</p>
                  </div>
